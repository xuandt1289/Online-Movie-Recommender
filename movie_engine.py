...
class RecommendationEngine:
    ...
    def get_rated_movies(self, user_id):
        user_id = int(user_id)
        user_rated_movies = self.ratings_RDD.filter(lambda rating: rating[0] == user_id)
        print("user_rated_movies is: ", user_rated_movies.take(3))
        rated_numer = user_rated_movies.count()
        print("rated_numer ", rated_numer)
        ...
        print("Done!")
        return rated_numer, user_rated_movies_high, user_rated_movies_low
    ...
    def __init__(self, sc, dataset_path):
        ...
        ratings_raw_RDD = self.sc.textFile(ratings_file_path, 2000)
